...
import { columnsCancel } from './columnsCancel'

import { getOrderCancel } from './store/action'
...
import SidebarNewOrder from '../../list/Sidebar'
...
const TableCancel = () => {
  ...
  const store = useSelector(state => state.orderCancel)
  ...
  const [status, setStatus] = useState('PAYMENT_CANCELLED')
  ...
  return (
    <Fragment>
      ...
      <SidebarNewOrder open={sidebarOpen} toggleSidebar={toggleSidebar} />
    </Fragment>
  )
}
